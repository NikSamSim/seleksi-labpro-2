...
export const applicationConfig = {
    ...
    cookieName: env.APP_A_COOKIE_NAME,
    sessionTtlSeconds: env.APP_A_SESSION_TTL_SECONDS,
    oauthTransactionTtlSeconds: env.APP_A_OAUTH_TRANSACTION_TTL_SECONDS,
    ...
    internalLogoutSecret: env.APP_A_INTERNAL_LOGOUT_SECRET
} as const;